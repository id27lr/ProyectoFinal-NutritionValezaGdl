...
<div class="col-md-6">
    <form action="{{ route('proveedor.store') }}" method="POST" class="form" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="form-group">
                <label for="nombre">Nombre</label>
                <input type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre" placeholder="Ingresa el nombre del proveedor" value="{{ old('nombre') }}">
                @error('nombre')
